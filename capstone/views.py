...
from .serializers import ArtistSerializer, SoundSerializer
from .models import Artist, Sound
from capstone import serializers
...
# def sound_list(request):
#     sounds = Sound.objects.all().values('artist', 'title', 'album', 'photo_url')
#     sounds_list = list(sounds)
#     return JsonResponse(sounds_list, safe=False)
